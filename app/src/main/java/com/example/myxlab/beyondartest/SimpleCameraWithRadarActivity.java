...
public class SimpleCameraWithRadarActivity extends FragmentActivity implements OnSeekBarChangeListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		gps = new TrackGPS(SimpleCameraWithRadarActivity.this);
		...
		//mWorld.setLocation(targetLocation);

		// .. and send it to the fragment
		mBeyondarFragment.setWorld(mWorld);
		//mBeyondarFragment.getWorld().setLocation(targetLocation);
		...
		mBeyondarFragment.getGLSurfaceView().setVisibility(View.VISIBLE);
		mBeyondarFragment.getCameraView().setVisibility(View.GONE);
